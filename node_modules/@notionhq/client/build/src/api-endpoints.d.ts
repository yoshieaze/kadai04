...
export declare const blocksUpdate: {
    ...
    readonly pathParams: readonly ["block_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["paragraph", "heading_1", "heading_2", "heading_3", "bulleted_list_item", "numbered_list_item", "toggle", "to_do", "archived"];
...
export interface BlocksDeleteParameters extends BlocksDeletePathParameters, BlocksDeleteQueryParameters, BlocksDeleteBodyParameters {
}
export interface BlocksDeleteResponse extends BlockBase {
}
export declare const blocksDelete: {
    readonly method: "delete";
    readonly pathParams: readonly ["block_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly [];
    readonly path: (p: BlocksDeletePathParameters) => string;
};
